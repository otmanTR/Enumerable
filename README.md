...
**[Enumerable]** is project do decode a morse code  message using Ruby.
...
2. clone with this command `git clone https://github.com/otmanTR/Enumerable.git
3. cd Enumerable
...
Feel free to check the [issues page](https://github.com/otmanTR/Enumerable/issues).
